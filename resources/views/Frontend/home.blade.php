                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <a href="tel:+18884476319" class="theme-btn">Contact Us <i class="icofont-double-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="intro-gallery">
                            <div class="tab-content" id="img-gallery">
                                ...
                                <div class="tab-pane fade show active" id="tab2" role="tabpanel" aria-labelledby="tab-02">
                                    <figure>
                                        <img src="/frontend/my-img/02.webp" alt="Gallery Image" />
                                    </figure>
                                </div>
        ...
        <div class="service-section">
            ...
            <div class="service-area">
                ...
                <div class="text-center">
                    <a href="tel:+18884476319" class="theme-btn">Call Now <i class="icofont-double-right"></i></a>
                </div>
            </div>
        </div>
        <!-- service-section end -->
        ...
        <div class="footer-top">
            <div class="container overflow-hidden">
                <div class="call-to-action wow animate__animated animate__slow animate__slideInUp">
                    ...
                    <a href="tel:+18884476319" class="theme-btn">Call for Support <i class="icofont-double-right"></i></a>
                </div>
            </div>
        </div>
        <!-- ================== -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <a href="tel:+18884476319" class="theme-btn mt-5">Contact Us <i class="icofont-double-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="intro-gallery">
